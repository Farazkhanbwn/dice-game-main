...
document
  ...
  .addEventListener("click", onCLickHoldButton);
...
const hasToTurnShift = (dice1, dice2) =>
  dice1 === SHIFT_TURN_VALUE || dice2 === SHIFT_TURN_VALUE;
...
document
  ...
  .addEventListener("click", onClickRollDiceButton);
